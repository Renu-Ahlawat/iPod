...
import sound from './assets/music/Euphoria.mp3'
    ...
    render(){
        return(
            <div style = {styles.ipodContainer}>
                ...
                <Screen activeItem={this.state.activeItem} activePage={this.state.activePage} audio={this.state.audio} isMenuVisible={this.state.isMenuVisible}/>
